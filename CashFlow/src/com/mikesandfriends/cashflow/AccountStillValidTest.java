...
/**
 * Used to test the method in Account which tests whether or not the balance is
 * still valid after a potential withdrawal.
 * 
 * @author Chelsea
 * 
 */
public class AccountStillValidTest extends TestCase {
    ...
    /**
     * Test if the initial balance is set to zero as shown in the Account
     * constructor.
     */
    ...
    /**
     * Test if the account is still valid after a potential withdrawal - should
     * be true because the balance is greater than the withdrawal.
     */
    ...
    /**
     * Test if the account is still valid after a potential withdrawal - should
     * be true because the balance is equal to the withdrawal. The balance is
     * allowed to be zero.
     */
    ...
    /**
     * Test if the account is still valid after a potential withdrawal - should
     * be false because the balance is less than the withdrawal.
     */
